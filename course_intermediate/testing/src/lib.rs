...
mod test {
    ...
    #[test]
    fn check_sploosh_returns_4() {
        assert_eq!(sploosh(1, 2, 3), 4);
    }

    #[test]
    fn check_sploosh_not_returning_4() {
        assert_ne!(sploosh(5, 6, 7), 4);
    }

    #[test]
    fn check_sploohs_returns_99() {
    ...
    #[test]
    fn check_splish_is_negative() {
        assert!(splish(100, 10) < 0);
    }

    #[test]
    fn check_splish_is_positive() {
        assert!(splish(40, 20) > 0);
    }

    #[test]
    fn check_splish_is_zero() {
